...
urlpatterns = [
    ...
    path('AdminPanel/insert_computer', custom_insert_preassembled_view, name="custom_insert_preassembled_view"),
    path('AdminPanel/remove_computer', custom_remove_preassembled_view, name="custom_remove_preassembled_view"),
